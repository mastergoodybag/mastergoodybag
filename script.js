  ...
  Ugbowo: {
    ...
    locations:{
      ...
      faculties:[
        ...
        {id:'medicine',name:'College of Medical Sciences',coords:[6.39607,5.62328],type:'faculty',description:'Medical and health sciences programs'},
        {id:'law',name:'Faculty of Law',coords:[6.40080,5.62218],type:'faculty',description:'Legal studies and jurisprudence'},
        {id:'arts',name:'Faculty of Arts',coords:[6.40396,5.62132],type:'faculty',description:'Humanities and liberal arts'},
        {id:'social_sciences',name:'Faculty of Social Sciences',coords:[6.40357,5.62189],type:'faculty',description:'Social sciences and behavioral studies'},
        {id:'education',name:'Faculty of Education',coords:[6.40093,5.61978],type:'faculty',description:'Educational studies and teacher training'},
        {id:'pharmacy',name:'Faculty of Pharmacy',coords:[6.39442,5.62132],type:'pharmaceutical sciences'},
        {id:'agriculture',name:'Faculty of Agriculture',coords:[6.40043,5.62337],type:'faculty',description:'Agricultural sciences and farming'},
        {id:'life_sciences',name:'Faculty of Life Sciences',coords:[6.39865,5.61514],type:'faculty',description:'Biological and life sciences'},
        {id:'physical_sciences',name:'Faculty of Physical Sciences',coords:[6.40013,5.61542],type:'faculty',description:'Physics, chemistry, mathematics, and related fields'},
        {id:'environmental_sciences',name:'Faculty of Environmental Sciences',coords:[6.40204,5.61958],type:'faculty',description:'Environmental studies and sustainability'},
        {id:'management_sciences',name:'Faculty of Management Sciences',coords:[6.39926,5.61797],type:'faculty',description:'Business, accounting, and management studies'}
      ],
      hostels:[
        {id:'Aminu_Kano_Hostel',name:'Hall 3(Aminu Kano Hostel)',coords:[6.39699,5.62073],capacity:800,description:'Mixed gender student accommodation'},
        {id:'Tinubu',name:'Hall 2(Tinubu Female Hostel)',coords:[6.39847,5.61966],capacity:600,description:'Female student accommodation'},
        {id:'Akanu_Ibiam',name:'Hall 4(Akanu Ibiam Hostel)',coords:[6.39805,5.62305],capacity:900,description:'Male undergraduate accommodation'},
        {id:'Hall_5',name:'Hall_5',coords:[6.39728,5.62403],capacity:400,description:'Mixed gender student accommodation'},
        {id:'daniel_hall',name:'Daniel Hall',coords:[6.3940,5.6080],capacity:500,description:'Male undergraduate accommodation'},
        {id:'Queen_Idia',name:'Hall 1(Queen Idia Hostel)',coords:[6.39685,5.61871],capacity:450,description:'Female undergraduate accommodation'},
